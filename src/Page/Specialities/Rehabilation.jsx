...
export default function Rehabilitation() {
  return (
    <>
      <SEO
        title="Orthopedic Rehabilitation in Prayagraj | Dr. Saurabh Tiwari"
        description="Comprehensive rehabilitation after orthopedic surgery, fractures and sports injuries."
        keywords="Orthopedic Rehabilitation Prayagraj"
        canonical="https://drsaurabhtiwariortho.com/specialities/rehabilitation"
