...
export default function Arthroscopy() {
  return (
    <>
      <SEO
        title="Arthroscopy Surgery in Prayagraj | Dr. Saurabh Tiwari"
        description="Minimally invasive arthroscopy for ligament injuries, sports injuries and joint disorders."
        keywords="Arthroscopy Prayagraj, Sports Injury Surgeon"
        canonical="https://drsaurabhtiwariortho.com/specialities/arthroscopy"
