...
export default function KneeReplacement() {
  return (
    <>
      <SEO
        title="Knee Replacement Surgeon in Prayagraj | Dr. Saurabh Tiwari"
        description="Expert knee replacement surgery for arthritis, knee pain and damaged knee joints."
        keywords="Knee Replacement Prayagraj, Knee Surgeon"
        canonical="https://drsaurabhtiwariortho.com/specialities/knee-replacement"
