...
export default function MinimallyInvasiveSurgery() {
  return (
    <>
      <SEO
        title="Minimally Invasive Orthopedic Surgery | Dr. Saurabh Tiwari"
        description="Advanced minimally invasive orthopedic procedures with less pain, smaller incisions and faster recovery."
        keywords="Minimally Invasive Orthopedic Surgery Prayagraj"
        canonical="https://drsaurabhtiwariortho.com/specialities/minimal-invasive-surgery"
