...
export default function SpineSurgery() {
  return (
    <>
      <SEO
        title="Spine Surgery Specialist in Prayagraj | Dr. Saurabh Tiwari"
        description="Expert treatment for slip disc, sciatica, spinal fractures, back pain and spine surgery by Dr. Saurabh Tiwari."
        keywords="Spine Surgeon Prayagraj, Back Pain Treatment, Slip Disc"
        canonical="https://drsaurabhtiwariortho.com/services/spine-surgery"
