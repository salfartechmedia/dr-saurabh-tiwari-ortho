...
import HipReplacementPic from '../../assets/HipReplacementPic.jpeg'
...
export default function HipReplacement() {
  return (
    <>
      <SEO
        title="Hip Replacement Surgery in Prayagraj | Dr. Saurabh Tiwari"
        description="Modern hip replacement surgery for hip arthritis, fractures and mobility restoration."
        keywords="Hip Replacement Prayagraj"
        canonical="https://drsaurabhtiwariortho.com/specialities/hip-replacement"
