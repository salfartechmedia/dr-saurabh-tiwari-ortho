...
export default function TraumaAndFractures() {
  return (
    ...
    <>
      <SEO
        title="Trauma & Fracture Treatment in Prayagraj | Dr. Saurabh Tiwari"
        description="Emergency fracture management, trauma surgery and orthopedic injury treatment."
        keywords="Fracture Doctor Prayagraj, Trauma Surgeon"
        canonical="https://drsaurabhtiwariortho.com/specialities/trauma-and-fracture"
