...
export default function GalleryPremium() {
  ...
  return (
    <>
      <SEO
        title="Gallery | Dr. Saurabh Tiwari Orthopedic Clinic"
        description="View clinic, surgeries, patient recovery stories and orthopedic treatment gallery of Dr. Saurabh Tiwari."
        keywords="Orthopedic Gallery Prayagraj"
        canonical="https://drsaurabhtiwariortho.com/gallery"
